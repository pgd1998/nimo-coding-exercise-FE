...
describe('formatLargeNumber', () => {
  ...
  it('should format small numbers as regular currency', () => {
    ...
    expect(formatLargeNumber(100.5)).toBe('$100.50')
  ...
  it('should handle edge cases at boundaries', () => {
    ...
    expect(formatLargeNumber(1000)).toBe('$1.00K')
    expect(formatLargeNumber(999999)).toBe('$1000.00K') // 999999/1000 = 999.999, rounds to 1000
    expect(formatLargeNumber(1000000)).toBe('$1.00M')
    expect(formatLargeNumber(999999999)).toBe('$1000.00M') // 999999999/1000000 = 999.999999, rounds to 1000
    expect(formatLargeNumber(1000000000)).toBe('$1.00B')
    expect(formatLargeNumber(999999999999)).toBe('$1000.00B') // Will round to 1000
    expect(formatLargeNumber(1000000000000)).toBe('$1.00T')
  })
  ...
  it('should handle negative numbers', () => {
    ...
    expect(formatLargeNumber(-1000000000)).toBe('$-1000000000.00')
    expect(formatLargeNumber(-1500000)).toBe('$-1500000.00')
  ...
  it('should round to 2 decimal places', () => {
    expect(formatLargeNumber(1234567890)).toBe('$1.23B') // 1.234... rounds to 1.23
    expect(formatLargeNumber(1999999999)).toBe('$2.00B') // 1.999... rounds to 2.00
  })
})